...
import { Container, ParseStats, BlockConfig, VesselStatsData } from './types';
...
const DEFAULT_BLOCKS: BlockConfig[] = [
  { name: 'A2', totalBays: 35, rowsPerBay: 6, tiersPerBay: 6, isDefault: true },
  { name: 'B2', totalBays: 35, rowsPerBay: 6, tiersPerBay: 6, isDefault: true },
  { name: 'C2', totalBays: 35, rowsPerBay: 6, tiersPerBay: 6, isDefault: true },
  { name: 'D2', totalBays: 35, rowsPerBay: 6, tiersPerBay: 6, isDefault: true },
  { name: 'E2', totalBays: 35, rowsPerBay: 6, tiersPerBay: 6, isDefault: true },
];
...
const App: React.FC = () => {
  ...
  const [searchTerm, setSearchTerm] = useState<string>('A2-22-05-1');
    ...
    <div className="min-h-screen text-slate-800 p-4 sm:p-6 lg:p-8">
      <div className="max-w-full mx-auto">
        ...
        <main>
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg mb-8 mt-6">
                ...
                <p className="mt-1 text-sm text-slate-500">Upload a file to see container data.</p>
                 <div className="mt-4 text-left text-xs text-slate-400 bg-slate-50 p-3 rounded-md">
                    ...
                    <ul className="list-disc list-inside">
                        ...
                        <li><b>Owner:</b> <span className="font-mono">Hãng khai thác</span>, <span className="font-mono">Chủ hàng</span>, or <span className="font-mono">Owner</span></li>
                    ...
                    <p className="mt-1 text-slate-500">
                      <b>Bay Layout:</b> Tiers are numbered bottom-up; Rows are numbered left-to-right.
                    </p>
                     <p className="mt-1 text-slate-500">
                      <b>40' Containers:</b> Use an even bay (e.g., 22) to span slots 21 & 23.
                    </p>
                 </div>
              </div>
            </div>
